...
public class GenericFunctionExtendedTest {
	...
	public void addTwoGFMethodExtended() {
		...
		// [[1, 2], 3] + [[3, 4], 5] = [[4, 6], 8]
		assertArrayEquals(new Object[] { new Object[] { 4, 6 }, 8 }, (Object[]) add
				.call(new Object[] { new Object[] { 1, 2 }, 3 }, new Object[] { new Object[] { 3, 4 }, 5 }));
	}
	...
	public void shouldIllegalArgumentExceptionWhenZeroMethods() {
		...
		try {
			empty.call(1, "a");
			fail("Should have thrown IllegalArgumentException because the generic " + "function has no methods.");
	...
	public void shouldIllegalArgumentExceptionWhenNoApplicableMethods() {
		...
		try {
			...
			fail("Should have thrown IllegalArgumentException because there is no " + "aplicable method.");
		} catch (IllegalArgumentException e) {
		}
	}
	...
	public void illegalArgumentExceptionMessage() {
		...
		try {
			...
			final String expectedMessage = "No methods for generic function add with "
					+ "args [[1, 2], 3] of classes [class [Ljava.lang.Object;, class " + "java.lang.Integer]";
	...
	public void testExplain() {
		final GenericFunctionExtended explain = new GenericFunctionExtended("explain");
